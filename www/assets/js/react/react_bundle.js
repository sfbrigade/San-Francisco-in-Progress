...
var ProjectProfile = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      { "class": "projectProfile clearfix" },
      React.createElement(
        "div",
        { style: closeStyle, "class": "projectProfile-close" },
        "Close"
      ),
      React.createElement(
        "h1",
      ...
      React.createElement("img", { style: imgStyle, src: this.props.picture })
    );
  }
});

React.render(React.createElement(ProjectProfile, null), document.getElementById("sidebar"));
