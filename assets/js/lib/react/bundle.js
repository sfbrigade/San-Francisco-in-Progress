...
module.exports = React.createClass({
  ...
  submitForm: function () {
    ...
    $("#email-form").replaceWith("<h3>Email subscribe successful</h3>");
  },
  close: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "p",
          null,
          "You will receive email notifications when this project is on the agenda for a public hearing."
        ),
        React.createElement("input", { onChange: this.saveEmail, type: "text", name: "email", className: "form-control", placeholder: "example@mail.com" }),
        React.createElement(
          "button",
          { onClick: this.submitForm, style: marginTop, className: "btn-info" },
          "Subscribe"
        )
      )
    );
...
},{"backbone":5,"react":153}],2:[function(require,module,exports){
"use strict";
...
},{"./project-list.js":3,"./project-profile.js":4,"backbone":5,"react":153}],3:[function(require,module,exports){
"use strict";
...
},{"backbone":5,"react":153}],4:[function(require,module,exports){
"use strict";
...
module.exports = React.createClass({
  ...
  render: function () {
    ...
    var nextHearing = React.createElement(
      "div",
      null,
      React.createElement(
        "h4",
    ...
    if (this.props.project.hearings.length > 0) {
      ...
      nextHearing = React.createElement(
        "div",
        null,
        React.createElement(
          "h4",
        ...
        React.createElement(
          ...
          null,
          " ",
          this.props.project.hearings[0].description || "",
          " "
        ),
        React.createElement(
          "span",
        ...
        React.createElement(
          ...
          null,
          " ",
          this.props.project.hearings[0].preliminaryRecommendation || "",
          " "
        )
      );
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        "button",
        { className: "btn-info", onClick: this.showEmailForm },
        "Subscribe for updates"
      ),
      React.createElement(
        "button",
        { className: "btn-info", onClick: this.goToHearingForm, style: marginLeft },
        "Add a Hearing"
      ),
      nextHearing
    );
...
},{"./email-subscribe-form.js":1,"backbone":5,"react":153}],5:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.1
