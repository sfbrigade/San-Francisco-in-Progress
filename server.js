...
, request = require('request')
, createEmail = require('./assets/js/example-email.js')
...
// SCHEMAS
var projectHearingSchema = require('./models/project_hearing_schema.js')
var ProjectHearing = mongoose.model('ProjectHearing', projectHearingSchema)

var projectSchema = require('./models/project_schema.js')
